  ...
  return (
    <div className="flex flex-col flex-shrink-0 z-10 select-none">
      ...
      <div
        ...
        className="h-14 border-b border-neutral-200 bg-white flex items-center justify-between px-3 sm:px-4"
      >
          ...
          <div className="flex flex-col min-w-0">
            <div className="flex items-center space-x-1.5 min-w-0">
              ...
              <button
                ...
                className={`p-1 hover:bg-neutral-100 rounded transition cursor-pointer ${
        ...
        <div className="flex-1 max-w-md mx-2 sm:mx-4 hidden lg:block">
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-1.5 bg-neutral-50 hover:bg-neutral-100 border border-neutral-200 rounded-lg text-xs text-neutral-500 transition group cursor-pointer"
          >
